...
#define GPPUD_UP 0x2
#define GPPUD_DOWN 0x1
#define GPPUD_OFFSET 0x94
#define GPPUD_CLK  0x98
...
extern struct bcm2835_peripheral inter;
extern struct bcm2835_peripheral gpu;
...
#define GPIO_READMULT(g) *(gpio.addr + 13) &= (g)
// I2C macros
